          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex flex-row">
                <button className="w-1/2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-0 px-4 mr-5 rounded">
                  Edit
                </button>
                <button className="w-1/2 bg-red-400 hover:bg-red-500 text-white font-bold py-0 px-4 ml-5 rounded">
                  Delete
                </button>
              </div>
            </div>
