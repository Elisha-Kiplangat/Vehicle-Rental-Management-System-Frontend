...
const AdminHome = () => {
  ...
  return (
    <div className="admin-home p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold mb-6 text-blue-700">Summary</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="metric-card bg-white p-6 shadow-md rounded-lg flex items-center">
          ...
          <div>
            <p className="text-2xl font-bold">{users?.totalCustomers || 0}</p>
        ...
        <div className="metric-card bg-white p-6 shadow-md rounded-lg flex items-center">
          ...
          <div>
            <p className="text-2xl font-bold">{bookings?.totalBooking || 0}</p>
        ...
        <div className="metric-card bg-white p-6 shadow-md rounded-lg flex items-center">
          ...
          <div>
            <p className="text-2xl font-bold">{unreadMessages?.totalMessages || 0}</p>
        ...
        <div className="metric-card bg-white p-6 shadow-md rounded-lg flex items-center">
          ...
          <div>
            <p className="text-2xl font-bold">{activeBookigs?.totalActiveBookings || 0}</p>
