    ...
    <div className="form-container sign-up absolute top-0 h-full transition-all ease-in-out duration-600 left-0 w-1/2 z-0">
      <form className="bg-white flex flex-col items-center justify-center py-0 px-10 h-full" onSubmit={handleSubmit}>
        <h1>Create Account</h1>
         <input className="bg-gray-200 border-none my-2 py-2 px-4 text-sm rounded-lg w-full outline-none" type="text" placeholder="Name" value={full_name} onChange={(e) => setName(e.target.value)} />
        ...
        <input className="bg-gray-200 border-none my-2 py-2 px-4 text-sm rounded-lg w-full outline-none" type="text" placeholder="Phone" value={contact_phone} onChange={(e) => setPhone(e.target.value)} />
        <input className="bg-gray-200 border-none my-2 py-2 px-4 text-sm rounded-lg w-full outline-none" type="text" placeholder="Address" value={address} onChange={(e) => setAddress(e.target.value)} />
